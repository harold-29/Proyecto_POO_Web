...
namespace Fase3_POO
{
    public partial class frmTecnologia : System.Web.UI.Page
    {
        ...
        private List<int> ProductoAscendete()
        {
            ...
            try
            {
                ...
                var consulta = from producto in dc.PRODUCTOS
                               where (producto.CATEGORIA_PRODUCTO == 1) && (producto.COSTO_PRODUCTO >= minPrice) && (producto.COSTO_PRODUCTO <= maxPrice)
        ...
        private decimal PrecioMaximo()
        {
            ...
            {
                var consulta = (from producto in dc.PRODUCTOS
                                where producto.CATEGORIA_PRODUCTO == 1
                                orderby producto.COSTO_PRODUCTO descending
