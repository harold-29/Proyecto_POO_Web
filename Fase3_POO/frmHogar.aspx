<%@ Page Title="" Language="C#" MasterPageFile="~/Plantilla.Master" AutoEventWireup="true" CodeBehind="frmHogar.aspx.cs" Inherits="Fase3_POO.frmMuebles" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="main" runat="server">
    <div class="container-xxl contenedor mb-5">
        ...
        <div class="container bd-main">
            <h1 class="mb-5 row">Articulos para el Hogar</h1>
