<%@ Page Title="" Language="C#" MasterPageFile="~/Plantilla.Master" AutoEventWireup="true" CodeBehind="frmTecnologia.aspx.cs" Inherits="Fase3_POO.frmTecnologia" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="main" runat="server">
    ...
    <div class="container-xxl contenedor mb-5" >
        <aside class="bd-sidebar">
            ...
            <form runat="server" id="form3" class="row-cols-4 row-cols-md-1">
